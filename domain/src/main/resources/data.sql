...
insert into shop_order (address, card_number, completed_at, email, final_price, name, age) values ( '87 New St', '7878787979877', CURRENT_TIMESTAMP() , 'new@new.nw', 47.88, 'New One', 19  );
insert into shop_order (address, card_number, completed_at, email, final_price, name, age) values ( '10 down st', '46231564', current_timestamp() , 'nm@new.po', 45.77, 'Old One', 55  );
insert into shop_order (address, card_number, completed_at, email, final_price, name, age) values ( 'no where', '65849856156', current_timestamp() , 'new@po.sd', 1.38, 'New This', 100  );
